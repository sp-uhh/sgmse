...
do
    python train.py --base_dir /data/richter/wsj0_chime3/ --batch_size 8 --gpus 4 --eval_start 100 --max_epochs 110 --num_eval_files 20 --spec_abs_exponent $spec_abs_exponent --spec_factor $spec_factor
done
